...
lowerCaseNames.map(function(item) {
...
lowPopulationAnimals.filter(function(item) {
    console.log(item.population <= 5)
})
...
const USApop = zooAnimals.reduce(accumulator, currentValue)
